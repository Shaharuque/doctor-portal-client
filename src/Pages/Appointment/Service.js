      ...
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <div className="card-actions justify-end">
            ...
            <label disabled={slots.length===0} className="btn btn-secondary text-white hover:bg-yellow-400 hover:border-yellow-400" onClick={()=>setTreatment(service)} for="booking-modal" class="btn modal-button">Book Appointment!</label>
          </div>
        </div>
      </div>
    </div>
